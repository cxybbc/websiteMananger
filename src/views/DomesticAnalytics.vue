<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%; margin-top: 10px;" border stripe :header-cell-class-name="'headerBg'"
            ...
            <el-table-column prop="website_name" label="网站" width="150" align="center" 
                column-key="webSiteName"
                :filters="[{ text: 'knockout', value: 'Proknockout_zn' }, { text: 'formmster', value: 'Formmasterapp_zn' }, { text: 'retouch', value: 'photoretouch_zn' }, { text: 'ppt', value: 'Imyppt_zn' }]"
                :multiple="true">
            ...
            <el-table-column prop="web_region" label="地域" width="150" align="center" 
                column-key="web_region">
                <template slot-scope="scope">
        ...
        export default {
            ...
            methods:{
                load(){
                    ...
                    this.request.post("/websiteMasterLog/domesticAnalytics", {
                ...
                exportData() {
                    ...
                    this.request.post("/websiteMasterLog/exportData", {
                        pageNum: this.pageNum,
                        pageSize: this.pageSize,
                        webSiteNames: this.webSiteName,
                        webRegions: this.webRegion,
