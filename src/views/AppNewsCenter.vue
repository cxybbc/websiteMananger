<template>
    <div>
        ...
        <main>
            ...
            <el-pagination class="pagination" @current-change="PaginaitonChange" background layout="prev, pager, next"
                :page-size="pageSize" :current-page="currentpage1" :total="total1" />
        </main>
    </div>
</template>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            addGroup() {
                this.isShowGroupEditorBox = true
            },
            hideGroupDialog() {
