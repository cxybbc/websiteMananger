<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%" border stripe :header-cell-class-name="'headerBg'"
            ...
            <el-table-column prop="webSiteName" label="网站" width="150" align="center" 
                ...
                :filters="[{ text: 'Proknockout_en', value: 'Proknockout_en' }, { text: 'Formmasterapp_en', value: 'Formmasterapp_en' }, { text: 'Photoretouch_en', value: 'photoretouch_en' }, { text: 'Imyppt_en', value: 'Imyppt_en' },
                            { text: 'Proknockout_zn', value: 'Proknockout_zn' }, { text: 'Formmasterapp_zn', value: 'Formmasterapp_zn' }, { text: 'Photoretouch_zn', value: 'photoretouch_zn' }, { text: 'Imyppt_zn', value: 'Imyppt_zn' }]"
                :multiple="true">
            ...
            <el-table-column prop="createTimeLog" label="日志时间" width="150" align="center">
            </el-table-column>
    ...
    <script>
        ...
        export default {
            ...
            methods:{
                load(){
                    this.request.post("/websiteMasterLog/logAnalytics", {
                ...
                sortLoad(){
                    ...
                    this.request.post("/websiteMasterLog/sortLogAnalytics", {
                        pageNum: this.pageNum,
                        pageSize: this.pageSize,
                        order: this.sort,
                ...
                filterDate() {
                    ...
                    this.request.post("/websiteMasterLog/dateList", {
                        pageNum: this.pageNum,
                        pageSize: this.pageSize,
                        webSiteNames: this.webSiteName,
                        webRegions: this.webRegion,
