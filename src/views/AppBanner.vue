<template>
  <div>
    ...
    <div style="padding: 10px 0">
      ...
      ></el-button>
      <el-button type="primary" @click="templateAddEn" style="text-align: right"
        >表格国外模板图片<i class="el-icon-circle-plus-outline"></i
      ></el-button>
      <el-button type="primary" @click="templateAddZh" style="text-align: right"
