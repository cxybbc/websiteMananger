<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%" :key="itemKey" border stripe :header-cell-class-name="'headerBg'"
    ...
    <el-dialog title="修改轮播图信息" :visible.sync="dialogFormVisible1" width="30%">
      <el-form label-width="80px" size="small" :model="form" ref="editForm">
        ...
        <el-form-item label="轮播图">
          ...
          <el-upload class="upload-demo" ref="upload" action="action" :on-change="handlePreview"
            :on-remove="handleRemove" :limit="1" :auto-upload="false" v-if="form.bannerAvaurl" style="margin-top: 3px">
