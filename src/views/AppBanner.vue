    ...
    <div>
        ...
        <div style="padding: 10px 0">
            ...
            <el-button
                ...
                >表格国外模板图片<i class="el-icon-circle-plus-outline"></i
            ></el-button>
            <el-button
                type="primary"
                @click="templateAddZh"
                style="text-align: right"
                >表格国内模板图片<i class="el-icon-circle-plus-outline"></i
            ></el-button>
        </div>
        <el-table
            :data="tableData"
        ...
        <el-dialog
            ...
            <el-form
                ...
                <el-form-item label="轮播图">
                    <el-input
                        v-model="form.bannerAvaurl"
                        autocomplete="off"
                        v-if="form.bannerAvaurl"></el-input>
                    <el-upload
                        class="upload-demo"
                        ref="upload"
                        action="action"
        ...
        <el-dialog
            ...
            <div class="inputDeep">
                <el-input
                    v-model="formUrlText"
                    placeholder="请输入需要检索的图片前缀名称"></el-input>
            </div>
            <div class="imgList">
                <div
                    class="img-item"
                    v-for="(item, index) in formUrlList"
                    :class="{active: item.bOn}"
                    :key="index"
                    @click="checkImg(index)">
                    <p style="margin-bottom: 5px; text-align: center; font-weight: bold; font-size: 14px">
                        {{ item.name }}
                    </p>
                    <img
                        :src="item.url"
