    ...
    >
      ...
      <el-table-column label="图标" width="150" align="center">
        <template slot-scope="scope">
          <img
            v-if="scope.row.navigationIcon"
            :src="'//' + scope.row.navigationIcon"
            alt=""
      ...
      <el-table-column label="二维码" width="150" align="center">
        <template slot-scope="scope">
          <img
            v-if="scope.row.navigationImg"
            :src="'//' + scope.row.navigationImg"
            alt=""
            style="width: 50px; height: 50px"
          />
          <el-progress
