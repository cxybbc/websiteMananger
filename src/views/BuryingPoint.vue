<template>
    <div class="b_p_view">
        ...
        <el-table :data="tableData" style="width: 100%" border stripe :header-cell-class-name="'headerBg'"
            ...
            <el-table-column prop="webName" label="国内站点" align="center"
    ...
    <script>
        export default {
            ...
            methods: {
                load() {
                    this.request.post("/buryingPoint/getBuryingPoint", {
                ...
                summaryList(webName, createTime) {
                    this.request.post("/buryingPoint/summaryData", {
                        webNames: webName,
                ...
                exportData() {
                    ...
                    this.request.post("/buryingPoint/exportData", {
                        webNames: this.webNameList,
                        createTimes: this.createTimeList
