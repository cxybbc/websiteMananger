<template>
    <div class="b_p_view">
        ...
        <el-table :data="tableData" style="width: 100%" border stripe :header-cell-class-name="'headerBg'" @filter-change="handleFilterButton" @sort-change="sortChange">
            <!-- <el-table-column prop="userIp" label="用户IP" width="150" align="center" sortable="custom"></el-table-column> -->
            <el-table-column prop="webName" label="国内站点" align="center" :filters="selectOptions" column-key="webName"></el-table-column>
            ...
            <el-table-column prop="createTime" label="生成时间" align="center" sortable :filters="dateList" column-key="createTime"></el-table-column>
