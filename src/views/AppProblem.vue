        ...
        <el-table :data="tableData" :key="itemKey" style="width: 100%" border stripe :header-cell-class-name="'headerBg'">
            ...
            <el-table-column prop="problemUrl" label="详情图" width="150" align="center">
                <template slot-scope="scope">
                    <img v-if="scope.row.problemUrl" :src="'//' + scope.row.problemUrl" alt="" style="width: 50px; height: 50px"/>
        ...
        <el-dialog title="新增常见问题" :visible.sync="dialogFormVisible" width="30%">
            <el-form label-width="80px" size="small" :model="form" ref="addForm">
                ...
                <el-form-item label="功能分类" prop="functionId" :rules="{
                    ...
                    <el-select clearable v-model="form.functionId" placeholder="请选择所属功能" value-key="id" style="width: 100%">
