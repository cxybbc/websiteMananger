...
export default {
    ...
    methods: {
        ...
        //   try {
        //     await this.request.post(`/user/getVerify`).then(res => {
        //       if (res.code == 200) {
        //         this.captchaImage = "data:image/jpg;base64,"+ res.data["imgCode"]
        //         this.code_id = res.data["uuid"]
        //       } else {
...
@font-face {
    ...
    src: url('font/iconfont.eot?t=1652091954316#iefix') format('embedded-opentype'), /* IE6-IE8 */ url('font/iconfont.woff2?t=1652091954316') format('woff2'), url('font/iconfont.woff?t=1652091954316') format('woff'), url('font/iconfont.ttf?t=1652091954316') format('truetype'),
...
.loginbox-in .el-form .el-form-item .el-form-item__content {
