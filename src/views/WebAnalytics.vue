<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%" border stripe :header-cell-class-name="'headerBg'"
            ...
            <el-table-column prop="webSiteName" label="网站" width="150" align="center" column-key="webSiteName"
            ...
            <el-table-column prop="webRegion" label="地域" width="150" align="center" column-key="webRegion"
                :filters="[{ text: '国内', value: '0' }, { text: '国外', value: '1' }]" :multiple="false">
                <template slot-scope="scope">
