    ...
    <div>
            ...
            <el-form label-width="80px" size="small" :model="form" ref="addForm">
                ...
                <el-form-item
                    ...
                    <div class="editor_container" v-if="dialogFormVisible">
                        ...
                        <Editor v-model="form.stepsText" ref="EditorRef" :defaultConfig="editorConfig2" style="height: 200px; overflow-y: hidden; border: 1px solid #eee" @onCreated="handleCreated2" @onChange="handleChange" @onDestroyed="handleDestroyed" @onFocus="handleFocus" @onBlur="handleBlur" />
                    </div>
                </el-form-item>
                <el-form-item
                    label="教程步骤序号"
                ...
                <el-form-item
                    ...
                    <el-select clearable v-model="form.appWebsiteId" placeholder="请选择官网" style="width: 100%" @change="changeAppWebsiteId">
                        <el-option v-for="item in appList" :key="item.id" :label="item.webSiteName" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="布局点" prop="pointId">
                    <el-select clearable v-model="form.pointId" style="width: 100%">
                        <el-option v-for="item in pointList" :key="item.id" :label="item.pointTitle" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item
                    label="功能分类"
                ...
                <el-form-item label="教程步骤详情" prop="infoContent">
                    <div class="editor_container" v-if="dialogFormVisible">
                        ...
                        <Editor v-model="form.infoContent" ref="EditorRef" :defaultConfig="editorConfig" style="height: 500px; overflow-y: hidden; border: 1px solid #eee" @onCreated="handleCreated" @onChange="handleChange" @onDestroyed="handleDestroyed" @onFocus="handleFocus" @onBlur="handleBlur" />
                    </div>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="教程步骤修改" :visible.sync="dialogFormVisible1" width="30%">
            <el-form label-width="80px" size="small" :model="form" ref="editForm">
                ...
                <el-form-item label="布局点" prop="pointId">
                    <el-input v-model="form.pointId" type="number" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item
                    label="功能分类"
                    prop="functionId"
