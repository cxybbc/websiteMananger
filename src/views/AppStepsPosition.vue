<template>
    <div>
        <div style="padding: 10px 0; text-align: right">
            <el-select clearable v-model="appWebsiteId" placeholder="请选择官网" style="width: 400px">
        ...
        <el-dialog title="新增布局点" :visible.sync="isStepsadd" width="40%">
            <el-form label-width="80px" size="small" ref="addForm" :model="form">
                <el-form-item
                    ...
                    <el-input v-model="form.pointTitle" placeholder="请输入布局点标题"></el-input>
                </el-form-item>
        ...
        <el-dialog title="编辑布局点" :visible.sync="isStepsedit" width="40%">
            <el-form label-width="80px" size="small" ref="addForm" :model="editForm">
                <el-form-item
                    ...
                    <el-input v-model="editForm.pointTitle" placeholder="请输入布局点标题"></el-input>
                </el-form-item>
                ...
                <el-form-item
                    ...
                    <el-input type="number" v-model="editForm.sortIndex" placeholder="请输入排序索引"></el-input>
                </el-form-item>
                <el-form-item
                    label="所属官网"
                    :rules="{
                    ...
                    <el-select clearable v-model="editForm.appWebSiteId" placeholder="请选择官网" style="width: 100%">
                        <el-option v-for="item in appList" :key="item.id" :label="item.webSiteName" :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
            </el-form>
